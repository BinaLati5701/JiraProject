...
<body>
	<div class="container">
	<h3 class="text-success mt-3 mb-4">Create a new Story</h3>
	<div class="newstory">
	<p class="text-danger">
				<form:errors path="story.*" />
			</p>
			<form:form class="form-group col" method="POST" action="/story/new"
				...
				<div class="row mb-2">
					<form:label class="col-sm-6 col-form-label" path="acceptanceCriteria">Acceptance Criteria:</form:label>
					<form:input class="col-sm-6" type="text" path="acceptanceCriteria" />
				</div>
				...
				<form:input type="hidden" path="story_creator" value="${logged_user.id}"/>
